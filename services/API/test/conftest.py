...
# Переопределяем зависимость для получения сессий
...
async def prepare_database():
    print(f"Подключение к базе данных: {engine_test.url}")
...
def event_loop(request):
    """Создаём экземпляр основного цикла событий для каждого теста."""
